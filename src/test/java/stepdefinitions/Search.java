...
public class Search {
	...
	public void user_enters_valid_product_into_s_earch_fiels() {
		System.out.println(">> Valid product was entered into Search field");
	}
	...
	public void user_enters_non_existing_product_into_search_fiels() {
		System.out.println(">> Non-existing product got entered in Search field");
	}

	@Then("Proper text informing the User about not product matching should be displayed")
	public void proper_text_informing_the_user_about_not_product_matching_should_be_displayed() {
		System.out.println(">> No product matching message got displayed");
	}

	@When("User do not enter any product into Search field")
	public void user_do_not_enter_any_product_into_search_fiels() {
		System.out.println(">> No product is entered in Search field");
	}
